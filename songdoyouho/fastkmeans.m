function [label, center, bCon, sumD, D] = fastkmeans(X, k, varargin)
...
%                 
%                 simi_x = bigdelta_Tx - bigdelta_Cx;
%                 simi_y = bigdelta_Ty - bigdelta_Cy;
%                 
%                 D = sqrt(simi_x.*simi_x + simi_y.*simi_y);
